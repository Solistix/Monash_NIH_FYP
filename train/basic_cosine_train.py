...
if __name__ == '__main__':
    ...
    path_models = '../../models/basic_cosine'  # Folder path to save the trained models to
    ...
    for epoch in range(num_epochs):
        ...
        if save_models:
            ...
            torch.save(model.state_dict(), os.path.join(path_models, f'basic_cosine_{epoch + 1}.pth'))  # Save the model
    ...
    df_results.to_csv(os.path.join(path_results, 'basic_cosine.csv'), index=False)  # Export results to a CSV file
