"""
This file trains the BioBERT model with a linear classification layer using the meta-learning framework. The BioBERT
model functions as the feature extractor.
"""
...
def main(k_shot):
    ...
    for step, (support_texts, support_masks, support_labels, query_texts, query_masks, query_labels) in enumerate(
            loader):
